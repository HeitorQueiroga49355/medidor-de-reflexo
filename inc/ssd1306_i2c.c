...
void ssd1306_send_buffer(uint8_t ssd[], int buffer_length) {
    ...
    i2c_write_blocking(i2c1, ssd1306_i2c_address, temp_buffer,
                       buffer_length + 1, false);
...
void ssd1306_scroll(bool set) {
    uint8_t commands[] = {ssd1306_set_horizontal_scroll | 0x00,
                          0x00,
                          0x00,
                          0x00,
                          0x03,
...
void ssd1306_send_data(ssd1306_t *ssd) {
    ...
    i2c_write_blocking(ssd->i2c_port, ssd->address, ssd->ram_buffer,
                       ssd->bufsize, false);
}
